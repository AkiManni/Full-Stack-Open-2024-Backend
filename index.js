...
// Gets rid of GET favicon.ico error msg on console
  ...
  Contact.findOne({ name: body.name })
    .then(existingContact => {
      if (existingContact) {
        ...
        // findByIdAndUpdate which was used in the examples, seemed to work as a roundabout for that.
...
// Must be put in use after every other middleware, OR ELSE
